...
\firstname{\textcolor{color1}{Thomas}} % Your first name
\familyname{\textcolor{color1}{Chauvet}} % Your last name

% All information in this block is optional, comment out any lines you don't need
% \title{Curriculum Vitae}
\address{Geneva, Switzerland}{}
% \mobile{}
\email{thomas.chauvet (at) icloud.com}
\homepage{www.linkedin.com/in/thomaschauvet/}{}
\extrainfo{\homepagesymbol\httplink{www.github.com/thomas-chauvet/}}% The first argument is %the url for the clickable link, the second argument is the url displayed in the %template - this allows special characters to be displayed such as the tilde in this %example
...
\textcolor{color2}{Data enthusiast, my aim is to build data products relying on artificial intelligence to help solving real life issues. The most, would be if said product has a strong and good impact on justice and social change.}
